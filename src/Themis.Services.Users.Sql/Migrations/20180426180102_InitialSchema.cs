...
namespace Themis.Services.Users.Sql.Migrations
{
    public partial class InitialSchema : Migration
    {
        private const string SeedScript =
                "INSERT INTO [dbo].[Users] ([FirstName], [LastName], [EmailAddress], [Country], [City], [Street])\r\nVALUES (\'Tom\', \'Kerkhove\', \'Tom.Kerkhove@codit.eu\', \'Belgium\', \'Ghent\', \'Gaston Crommenlaan 14\'),\r\n       (\'Bill\', \'Bracket\', \'Bill.Bracket@codit.eu\', \'Belgium\', \'Ghent\', \'Gaston Crommenlaan 14\')";
